...
% executables in bin, bit more discussion dnabr results
% dnabr minimaal
% voorbeeldoutput, alleen de kleine files, alleen top nodig
% GMXLIB
% genereer tpr zelf, verander timestep naar de juiste, oude verwijderen
% vermeld compilen kan lang duren bij een lang sourcetrajectory
% genereer een korter sourcetraj
...
% TODO: acceptatieregel in math of woorden, netjes om te noemen, niet de afleiding
